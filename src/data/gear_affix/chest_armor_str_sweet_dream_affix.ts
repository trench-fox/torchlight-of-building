...
export const CHEST_ARMOR_STR_SWEET_DREAM_AFFIX_AFFIXES = [
  {
...
export type ChestArmorStrSweetDreamAffixAffix =
  (typeof CHEST_ARMOR_STR_SWEET_DREAM_AFFIX_AFFIXES)[number];
