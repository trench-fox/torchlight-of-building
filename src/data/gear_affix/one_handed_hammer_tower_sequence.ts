...
export const ONE_HANDED_HAMMER_TOWER_SEQUENCE_AFFIXES = [
  {
...
export type OneHandedHammerTowerSequenceAffix =
  (typeof ONE_HANDED_HAMMER_TOWER_SEQUENCE_AFFIXES)[number];
