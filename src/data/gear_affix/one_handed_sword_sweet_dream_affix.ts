...
export const ONE_HANDED_SWORD_SWEET_DREAM_AFFIX_AFFIXES = [
  {
...
export type OneHandedSwordSweetDreamAffixAffix =
  (typeof ONE_HANDED_SWORD_SWEET_DREAM_AFFIX_AFFIXES)[number];
